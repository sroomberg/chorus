...
Remind the host that joiners need a display name. If requireApproval is true, pending joiners appear as a live numbered queue on screen — approve with /chorus-approve 1 (or A), not the full userId.
